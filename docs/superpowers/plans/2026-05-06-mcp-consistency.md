...
**Files:**
- Create: `~/Projects/consistency-check/.gitignore`
- Create: `~/Projects/consistency-check/pyproject.toml`
- Create: `~/Projects/consistency-check/consistency_check/__init__.py`
- Create: `~/Projects/consistency-check/tests/__init__.py`
...
**Files:**
- Modify: `~/Projects/unifi-mcp/CLAUDE.md` (append section)
- Modify: `~/Projects/unraid-mcp/CLAUDE.md` (append section)
- Modify: `~/Projects/gandi-mcp/CLAUDE.md` (append section)
- Create: `~/Projects/protonmail-mcp/CLAUDE.md` (new file)
...
Authoritative source: `~/Projects/consistency-check/docs/standards/`. This repo is graded against `mcp.md` + the language-specific file (`python.md` for Python repos, `go.md` for Go) + `mcp-protocol.md`.

Run the audit:

\`\`\`bash
cd ~/Projects/consistency-check
uv run consistency-check audit --repo $(basename $(git -C ~/Projects/$(basename "$PWD") rev-parse --show-toplevel))
\`\`\`
```
...
Authoritative source: `~/Projects/consistency-check/docs/standards/`. This repo is graded against `mcp.md`, `go.md`, and `mcp-protocol.md`.
