...
def test_go_009_fail_when_package_never_wraps_split_across_files(good_go_repo: Path) -> None:
    # Sibling files in the same package: neither wraps, so the bare return stays
    # flagged even though the helper it calls lives in another file.
